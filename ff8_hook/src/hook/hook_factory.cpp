...
FactoryResult HookFactory::create_hooks_from_config(
...
FactoryResult HookFactory::create_hook_for_address_generic(
...
FactoryResult HookFactory::create_hook_for_address(
    std::uintptr_t address,
